...
- Vague idea: `mf-interview`.
- Clear idea: `mf-video-prompt`.
- Long story or connected clips: `mf-sequence`.
- Continue, extend, repair tail, or re-anchor accepted footage: `mf-continuation`.
- Short prompt: `mf-video-prompt-short`.
- Bad result: `mf-troubleshoot`.
- IP or real-person risk: `mf-safety-rewrite`.
- Blocked prompt: `mf-safety-rewrite`.
