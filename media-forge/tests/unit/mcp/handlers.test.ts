...
describe('registerAllTools()', () => {
  ...
  // Test 1: exactly 34 tools registered (26 base + media_video_webhook_status + media_video_cost_estimate + media_video_cost_report + media_video_route added P13 + media_higgsfield_soul_id + media_higgsfield_dop + media_higgsfield_cinema_studio + media_higgsfield_speak added P14)
  it('calls registerTool exactly 34 times', () => {
    const mock = server as unknown as { registerTool: ReturnType<typeof vi.fn> };
    expect(mock.registerTool).toHaveBeenCalledTimes(34);
  });
