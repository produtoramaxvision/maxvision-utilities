...
export default defineConfig({
  ...
  test: {
    globals: true,
    environment: 'node',
    include: ['tests/unit/**/*.test.ts', 'tests/core/**/*.test.ts', 'tests/video/**/*.test.ts', 'tests/cli/**/*.test.ts', 'tests/mcp/**/*.test.ts', 'src/**/*.test.ts', 'tests/integration/p13-regression.test.ts', 'tests/integration/p14-regression.test.ts', 'tests/integration/p15-kling-live.test.ts', 'tests/integration/p15-regression.test.ts'],
