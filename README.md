...
[![Plugins](https://img.shields.io/badge/plugins-2-success)](#plugins)

> **MaxVision's curated Claude Code marketplace.** Production-grade skills, packaged for reliable consumption.

A self-hosted Claude Code marketplace bundling expert skill packs from across the MaxVision stack — starting with n8n workflow automation and Google Tag Manager API operations.
...
You should see both plugins listed under marketplace `maxvision-claude`.
